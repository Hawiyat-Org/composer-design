...
function fakeConfig(): PackagedConfig {
  return {
    ...
    namespaceBaseRoot: join("C:", "Users", "Fred", "AppData", "Roaming", "Composer Design", "namespaces"),
    nodeCommand: null,
    posthogHost: null,
    posthogKey: null,
    resourceRoot: join("C:", "Program Files", "Composer Design", "resources", "composer-design"),
