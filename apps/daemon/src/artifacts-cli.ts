...
Creates one normal Composer Design project artifact entry file through the local daemon.
When --project is omitted, the active Composer Design project is used.
