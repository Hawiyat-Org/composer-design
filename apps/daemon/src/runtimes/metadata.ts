...
> = {
  ...
  amr: {
    ...
    docsUrl: 'https://github.com/hawiyat/composer-design/blob/main/docs/new-agent-runtime-acp.md',
  },
  claude: {
  ...
  hermes: {
    installUrl: 'https://github.com/hawiyat/composer-design/blob/main/docs/agent-adapters.md',
