...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows ComposerDesign's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# ComposerDesign integration — MUST follow

You are running inside ComposerDesign, a design tool. The user message contains
