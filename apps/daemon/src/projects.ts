...
function buildDesignManifest(entries, projectLabel) {
  ...
  return JSON.stringify({
    ...
    title: projectLabel || 'Composer Design project',
    entryFile,
    sourceFiles: {
      all: files,
      html: htmlFiles,
...
function buildDesignHandoff(entries, projectLabel) {
  ...
  return `# ${projectLabel || 'Composer Design project'} implementation handoff
...
- Keep generated product UI free of Composer Design chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Composer Design chrome in the production UI.
