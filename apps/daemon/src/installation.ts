...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/Composer Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/Composer Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/Composer Design Prerelease/installation.json
