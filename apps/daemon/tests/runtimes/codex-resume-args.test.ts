...
import {
  codexAgentDef,
  codexComposerDesignShellEnvironmentArgs,
...
describe('codex buildArgs session resume', () => {
  ...
  it('carries only the ComposerDesign wrapper contract across Codex shell environment filtering', () => {
    const args = codexAgentDef.buildArgs('prompt', [], [], {}, {});
    const shellArgs = codexComposerDesignShellEnvironmentArgs();
