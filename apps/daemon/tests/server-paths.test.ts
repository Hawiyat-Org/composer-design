...
describe('resolveDaemonPluginPreviewsDir', () => {
  it('resolves under the resource root in the packaged layout', () => {
    ...
    const resourceRoot = '/Applications/Composer Design.app/Contents/Resources/open-design';
    const projectRoot = '/Applications/Composer Design.app/Contents/Resources/app';
