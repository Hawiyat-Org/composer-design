...
describe('local ComposerDesign MCP brief app', () => {
  ...
  it('keeps user-facing MCP copy on public ComposerDesign product terms', () => {
    ...
    expect(userFacingCopy).toContain('ComposerDesign Cloud');
