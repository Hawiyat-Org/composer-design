...
describe('agent-driven brand extraction engine', () => {
  ...
  it('prefers source-backed human brand tokens over script/debug color noise', () => {
    const brand = brandFromMaterial({
      ...
      siteName: 'ComposerDesign',
      title: 'ComposerDesign',
      description: 'ComposerDesign design system.',
      colors: [
      ...
      fontFiles: [],
      logos: [],
      headings: ['ComposerDesign The Open-source Claude Design alternative'],
      paragraphs: ['ComposerDesign is a local-first design platform.'],
      navLabels: [],
      extraPages: [],
      screenshot: null,
      thin: false,
