...
function renderActions(
  ...
  const ui = (
    <NextStepActions
      ...
      onShareToComposerDesign={handlers.onShareToComposerDesign}
      skills={[
...
describe('NextStepActions', () => {
  ...
  it('cascades into Share / Download / Contribute and routes each action', () => {
    ...
    expect(h.onShareToComposerDesign).toHaveBeenCalledTimes(1);
  });
  ...
  it('hides the More row when nothing behind it is wired', () => {
    renderToolbox({
      ...
      onShareToComposerDesign: undefined,
