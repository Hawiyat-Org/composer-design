...
const AUTHORING_PLUGIN = {
  ...
  manifest: {
    ...
    od: {
      ...
      useCase: { query: 'Create a Composer Design plugin for {{pluginGoal}}.' },
      inputs: [
        {
          name: 'pluginGoal',
          type: 'string',
...
const LIVE_ARTIFACT_PLUGIN = {
  ...
  manifest: {
    ...
    title: 'Live Artifact',
    description: 'Create refreshable, auditable Composer Design artifacts.',
    od: {
      kind: 'scenario',
      taskKind: 'new-generation',
      mode: 'prototype',
      scenario: 'live',
      useCase: {
        query: 'Create refreshable, auditable Composer Design artifacts backed by connector or local data.',
      },
      context: {
...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Composer Design plugin',
  audience: 'Composer Design plugin authors',
  topic: 'packaging a reusable workflow as a Composer Design plugin',
};
