...
const {
  ...
  isComposerDesignHostAvailableMock,
  ...
  isComposerDesignHostAvailableMock: vi.fn(() => false),
...
vi.mock('../../src/runtime/exports', async () => {
  ...
  return {
    ...
    isComposerDesignHostAvailable: isComposerDesignHostAvailableMock,
...
describe('FileViewer version download actions', () => {
  afterEach(() => {
    cleanup();
    vi.clearAllMocks();
    isComposerDesignHostAvailableMock.mockReturnValue(false);
    vi.unstubAllGlobals();
  });

  it('routes current version PDFs through the main download PDF exporter', async () => {
    isComposerDesignHostAvailableMock.mockReturnValue(true);
