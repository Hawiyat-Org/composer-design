  ...
  AssistantMessage: ({
    ...
    <>
      ...
      {onShareToOpenDesign ? (
        ...
        >
          {shareToOpenDesignBusy ? 'Preparing package…' : 'Share to Composer Design'}
        </button>
      ) : null}
    </>
  ),
...
- A clear DESIGN.md with all generated rules.`,
  ...
  it('keeps Share to Composer Design busy on the assistant turn that started packaging', () => {
    ...
    rerender(
      <ChatPane
        ...
        messages={[
          ...initialMessages,
          { id: 'user-2', role: 'user', content: 'Share to Composer Design', createdAt: 4 },
          {
            id: 'assistant-2',
            role: 'assistant',
            content: '',
