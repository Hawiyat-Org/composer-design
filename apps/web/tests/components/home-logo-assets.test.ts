...
// #5517: the home hero header shows the full ComposerDesign logotype instead of
...
// The current ComposerDesign brand glyph is the ink superellipse tile introduced
