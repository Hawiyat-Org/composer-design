...
describe('web-clone example-card tracking', () => {
  ...
  // narrowed to the first-party ComposerDesign site to avoid shipping third-party
  ...
  it('resolves exactly the contracted ComposerDesign Website-clone site card', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('renders the contracted ComposerDesign site card with a local eager logo', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('falls back when the local ComposerDesign site card logo cannot load', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
