...
const OPEN_DESIGN_REPO_URL = 'https://github.com/hawiyat/composer-design';
const OPEN_DESIGN_REPO_LABEL = 'hawiyat/composer-design';
 ...
 * "ComposerDesign" still yield a two-letter monogram ("OD").
 */
