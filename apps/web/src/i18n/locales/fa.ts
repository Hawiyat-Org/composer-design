...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل ComposerDesign Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrError.authMessage': 'حساب ComposerDesign Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی ComposerDesign Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه ComposerDesign Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت ComposerDesign Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.title.signInRequired.amr': 'به Composer Design وارد نشده‌اید',
  ...
  'chat.runError.title.runtimeConfig': "خطای اجرای Composer Design",
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. ComposerDesign را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} از شروع جلسه خودداری کرد. معمولاً نسخهٔ نصب‌شده با Composer Design سازگار نیست؛ به نسخهٔ دیگری تغییر دهید و دوباره تلاش کنید.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "پاسخ عامل بدون نشانه‌ای که Composer Design برای ثبت این مرحله لازم دارد برگشت؛ به همین دلیل کار نتوانست ادامه یابد. هیچ‌چیز از آنچه فرستادید از دست نرفته است؛ این مورد گاه‌به‌گاه پیش می‌آید و معمولاً تلاش دوباره کارساز است.",
  ...
  'settings.welcomeTitle': 'به ComposerDesign خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. ComposerDesign یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. ComposerDesign در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingExecutionBody': 'از سرویس میزبانی‌شده ComposerDesign استفاده کنید، یک عامل محلی را متصل کنید یا کلید مدل خود را بیاورید.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی ComposerDesign Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد ComposerDesign Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به ComposerDesign، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب ComposerDesign Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به ComposerDesign Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'ComposerDesign را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم ComposerDesign به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود ComposerDesign کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد ComposerDesign را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما ComposerDesign نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های ComposerDesign شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که ComposerDesign در حال اجراست، سپس این پنل را دوباره باز کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در ComposerDesign باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، ComposerDesign باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن ComposerDesign راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.xAria': 'برای دیدن قابلیت‌های تازه @ComposerDesignHQ را دنبال کنید',
  ...
  'entry.followXLabel': 'دنبال کردن @ComposerDesignHQ در X',
  ...
  'entry.followLinkedinLabel': 'دنبال کردن ComposerDesign در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن ComposerDesign در Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "برای استفاده از ComposerDesign Cloud و همکاری در فضای ابری وارد شوید",
  "entry.cloudCalloutDismissAria": "بستن یادداشت ComposerDesign Cloud",
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد ComposerDesign بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت ComposerDesign Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه ComposerDesign:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده ComposerDesign که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با ComposerDesign ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در ComposerDesign',
  'pluginCard.contributeTitle': 'مشارکت افزونه در ComposerDesign با یک PR',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از ComposerDesign در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید ComposerDesign در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از ComposerDesign در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از ComposerDesign در همه‌جا',
  'useEverywhere.modalSubtitle': 'ComposerDesign را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'ComposerDesign هر جا که Agent شما کار کند، کار می‌کند',
  ...
  'useEverywhere.section.overview.bullet2': 'سرور MCP — ComposerDesign را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به ComposerDesign اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل ComposerDesign از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن ComposerDesign به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'ComposerDesign با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای ComposerDesign را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن ComposerDesign، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های ComposerDesign)',
  ...
  'entry.githubStarAria': 'به ComposerDesign در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های ComposerDesign',
  ...
  'avatar.amrConsole': 'حساب ComposerDesign Cloud',
  ...
  'socialShare.composerDesignSection': 'اشتراک‌گذاری ComposerDesign',
  'socialShare.composerDesignTitle': 'ComposerDesign در GitHub',
  'socialShare.composerDesignText': 'ComposerDesign یک فضای کاری با کد منبع در دسترس برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با ComposerDesign: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با ComposerDesign: {title}\n{url}\nمخزن ComposerDesign: {repo}',
  ...
  'brandEnrichment.body': "ComposerDesign یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از ComposerDesign بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید ComposerDesign فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.shareTextDefault': 'قالب ComposerDesign: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید ComposerDesign در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip7': 'از ComposerDesign راضی هستید؟ در GitHub به ما ستاره بدهید.',
  'designFiles.usefulInfoTip8': 'برای آخرین خبرها @ComposerDesignHQ را در X دنبال کنید.',
  ...
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، ComposerDesign را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، ComposerDesign را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، ComposerDesign را در Xiaohongshu دنبال کنید.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'اشتراک‌گذاری سریع · ComposerDesign',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'ایجاد پیوند اشتراک‌گذاری نیازمند ورود به فضای کاری است. به ComposerDesign Cloud وارد شوید یا این فایل را از طریق استقرار به اشتراک بگذارید.',
  ...
  'assistant.shareToComposerDesign': 'اشتراک‌گذاری در ComposerDesign',
  'assistant.shareToComposerDesignBusy': 'در حال آماده‌سازی بسته…',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه ComposerDesign — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه ComposerDesign ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ ComposerDesign را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که ComposerDesign باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'ComposerDesign v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'ComposerDesign هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'ComposerDesign نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'ComposerDesign {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. ComposerDesign در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن ComposerDesign',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما ComposerDesign بسته نشد. پیش از جایگزینی برنامه، ComposerDesign را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. ComposerDesign بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'ComposerDesign {version} آماده است. ComposerDesign بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. ComposerDesign بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'ComposerDesign {version} به نصب مجدد کامل نیاز دارد. ComposerDesign بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'whatsNew.updatedTitle': 'ComposerDesign {version} آمد',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به ComposerDesign بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که ComposerDesign در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'ComposerDesign برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'ds.composerDesignMd': 'باز کردن DESIGN.md',
  'ds.copyDesignMdModule': 'کپی بخش {module}',
  'ds.editDesignMdModule': 'ویرایش بخش {module}',
  'ds.composerDesignMdModule': 'باز کردن بخش {module}',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'از ۱۳ تا ۲۷ اوت، کاربران پولی می‌توانند DeepSeek V4 Pro و V4 Flash را در ComposerDesign رایگان استفاده کنند. سوءاستفاده گسترده ممکن است دسترسی کمپین را متوقف کند.',
  'campaign.deepseekV4Flash.windowLabel': '۱۳–۲۷ اوت',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'دو هفته رایگان',
  'campaign.deepseekV4Flash.boundary': 'سهمیه نامحدود مدل و تعداد تولید رایگان پلن فقط داخل ComposerDesign اعمال می‌شود — نه از طریق MCP، CLI، API یا سطوح دیگر. تفسیر نهایی با ComposerDesign است. برخی مدل‌ها ممکن است در ساعات شلوغی نیاز به نوبت داشته باشند.',
  ...
  'experienceSurvey.tag': "منتظر بازخورد شما هستیم — با هم ComposerDesign را بهتر کنیم",
  'experienceSurvey.close': "بستن",
  'experienceSurvey.recommendation': "چقدر احتمال دارد ComposerDesign را به همکار یا دوستتان پیشنهاد دهید؟",
  ...
  'chat.designSystemStatus.description': "Composer Design در حال استفاده از منابع راه‌اندازی برای ساخت این پروژه است.",
  'labs.title': "آزمایشگاه Composer Design",
  ...
  'labs.harnessHint': "با فعال‌سازی، تولید بعدی از جدیدترین استراتژی ComposerDesign استفاده می‌کند و خروجی محسوساً پرداخته‌تر است (بتا)",
  'labs.harnessTooltip': "به agent harness ای که Composer Design برای کارهای طراحی ساخته سوئیچ می‌کند. چیدمان، ساختار و کامل بودن خروجی به‌طور محسوس بهتر می‌شود.",
  ...
  'chat.pluginAction.contributionStarted': 'وظیفه مشارکت ComposerDesign برای {path} آغاز شد.',
