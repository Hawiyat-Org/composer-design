...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di Composer Design — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'chat.runError.signInMessage.amr': 'L\'agente Composer Design non ha ancora effettuato l\'accesso — accedi per iniziare a usarlo.',
  'chat.runError.signInMessage.other': '{agent} non ha effettuato l\'accesso. Controlla lo stato di accesso in locale. Consigliamo l\'agente Composer Design — più stabile e conveniente.',
  ...
  'settings.welcomeTitle': 'Ti diamo il benvenuto in Composer Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Inizia da un brief',
  'settings.onboardingCreateBody': 'Descrivi il sito, l\'app, la presentazione, l\'immagine o il video che desideri. Composer Design creerà un progetto e manterrà il lavoro modificabile.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Queste risposte costituiscono la base del tuo profilo di Memoria. Composer Design la riutilizza in ogni attività e continua a imparare mentre lavori.',
  ...
  'settings.onboardingCloudTitle': 'Accedi a Composer Design',
  'settings.onboardingCloudBody': 'Accedi e inizia subito a progettare con l’IA nel cloud, senza configurazioni complesse.',
  'settings.onboardingCloudSignIn': 'Accedi a Composer Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'I passaggi successivi vengono eseguiti tramite IA — accedi a Composer Design AMR per continuare.',
  ...
  'settings.agentInstall.pathHint': 'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Composer Design (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth': 'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Composer Design.',
  ...
  'settings.mcpServerHint': 'Esponi Composer Design come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Composer Design',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Composer Design',
  'settings.privacyConsentLead': 'Composer Design può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'settings.mcpHint': 'Consenti agli agent di coding (Cursor, Claude Code, VS Code…) di leggere direttamente i tuoi progetti Composer Design.',
  'settings.mcpDaemonError': 'Impossibile raggiungere il daemon locale per risolvere i percorsi di installazione ({error}). Assicurati che Composer Design sia in esecuzione, quindi riapri questo pannello.',
  ...
  'settings.mcpCapabilityDefault': 'Utilizzare per impostazione predefinita il progetto e il file che hai aperto in Composer Design, così puoi dire "build this in my app" senza dover ripetere quale design.',
  'settings.mcpRunningNote': 'Composer Design deve essere in esecuzione affinché le chiamate agli strumenti MCP abbiano successo. Se hai avviato il tuo coding agent prima di aprire Composer Design, riavvia l\'agent in modo che possa raggiungere il daemon attivo.',
  ...
  'entry.discordAria': 'Unisciti al Discord di Composer Design',
  'entry.discordAriaWithOnline': 'Unisciti al Discord di Composer Design - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Crea un plugin Composer Design riutilizzabile e aggiungilo a I miei plugin.',
  ...
  'handoff.promptIntro': 'Continua da questa cartella di progetto locale di Composer Design:',
  ...
  'pluginsHome.subtitle': 'Workflow di Composer Design pronti all\'uso inclusi in questo runtime. Scegline uno per caricare un prompt iniziale oppure esplora il registry per altro.',
  ...
  'pluginsHome.emptyCatalog': 'Il catalogo è vuoto. I plugin inclusi sono forniti con Composer Design e dovrebbero comparire qui automaticamente — prova a riavviare il daemon se il problema persiste.',
  ...
  'pluginCard.contributeAria': 'Contribuisci con {title} a Composer Design',
  'pluginCard.contributeTitle': 'Contribuisci con il plugin a Composer Design tramite una pull request',
  ...
  'integrations.lede': 'Collega sistemi esterni, porta gli strumenti MCP nel loop del tuo agent e usa Composer Design da altri IDE, script e automazioni.',
  ...
  'mcpClient.daemonError': 'Impossibile raggiungere il daemon locale. Assicurati che Composer Design sia in esecuzione, quindi riapri questo pannello.',
  'mcpClient.saveFailed': 'Salvataggio non riuscito. Verifica che il daemon sia in esecuzione e riprova.',
  'useEverywhere.modalAria': 'Usa Composer Design ovunque',
  'useEverywhere.modalTitle': 'Usa Composer Design ovunque',
  'useEverywhere.modalSubtitle': 'Integra Composer Design in qualsiasi IDE, agent o script — CLI, HTTP, MCP e Skill. Usa “Copia la guida per un agent” e incollala in Claude Code, Codex, Cursor, openclaw o hermes per configurare tutto.',
  ...
  'useEverywhere.section.overview.heading': 'Composer Design funziona ovunque lavori il tuo agent',
  'useEverywhere.section.overview.intro': 'Composer Design è molto più di una finestra — è un daemon locale con privilegi (`od`) più un registro di Skill + Design System + Atoms. Una volta in esecuzione sulla tua macchina, qualsiasi agent di codice (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, un tuo script) può avviare generazioni, ispezionare progetti e produrre artefatti di design attraverso quattro interfacce intercambiabili.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` per script headless, CI e automazione da shell.',
  'useEverywhere.section.overview.bullet2': 'Server MCP — collega Composer Design come server Model Context Protocol così che qualsiasi agent compatibile con MCP possa elencare skill, eseguire scenari e leggere artefatti.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skill — pacchetti `SKILL.md` pronti all\'uso (compatibili con Claude) che qualsiasi agent già presente nel tuo PATH può invocare senza Composer Design.',
  ...
  'useEverywhere.section.cli.heading': 'Controlla Composer Design da qualsiasi shell',
  ...
  'useEverywhere.section.mcp.heading': 'Esponi Composer Design come server MCP a qualsiasi coding agent',
  'useEverywhere.section.mcp.intro': 'Composer Design include un server Model Context Protocol (`od mcp`) che consente a qualsiasi client compatibile con MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — di scoprire gli strumenti di Composer Design (elenca skill, genera anteprime, genera media, esegui plugin) senza ricorrere manualmente alla shell. Il daemon pubblica uno snippet di installazione pronto da incollare tramite `GET /api/mcp/install-info` per ogni client principale.',
  ...
  'useEverywhere.section.mcp.footer': 'Nell\'app Composer Design, apri Impostazioni → Integrazioni per copiare un comando di installazione specifico per il client (Cursor, Claude Code, Antigravity, VS Code) invece di modificare il JSON manualmente.',
  ...
  'useEverywhere.section.skills.heading': 'Skill pronte all\'uso per qualsiasi agent — anche senza Composer Design in esecuzione',
  'useEverywhere.section.skills.intro': 'Una Skill è una directory con un file `SKILL.md` compatibile con Claude (front-matter YAML + corpo). Composer Design estende il formato con il namespace `od:` (`mode`, `preview`, `design_system`, `inputs`, …) così che lo stesso artefatto possa essere usato sia all\'interno di Composer Design sia da un agent standard come Claude Code, Codex, openclaw o hermes. Il rilevamento segue una catena di precedenza così che i progetti possano sovrascrivere le proprie skill.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimale (front matter compatibile con Claude + extra di Composer Design)',
  ...
  'entry.githubStarAria': 'Assegna una star a Composer Design su GitHub',
  ...
  'newproj.locationDefault': 'Progetti Composer Design',
  ...
  'socialShare.openDesignSection': 'Condividi Composer Design',
  'socialShare.openDesignTitle': 'Composer Design su GitHub',
  'socialShare.openDesignText': 'Composer Design è uno spazio di lavoro open-source per creare, modificare, distribuire e consegnare artifact di design.',
  ...
  'socialShare.projectText': 'Creato con Composer Design: {title}. Visualizza l\'artifact distribuito e metti una stella al repo: {repo}',
  'socialShare.projectCopyText': 'Creato con Composer Design: {title}\n{url}\nRepo di Composer Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Chiedi a Composer Design di modificare {file}...',
  ...
  'chat.mode.design.solves': 'Usala quando vuoi che Composer Design generi file, aggiorni il workspace o trasformi un brief in deliverable multimodali.',
  ...
  'preview.shareTextDefault': 'Template Composer Design: {title}',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Composer Design sia in esecuzione e riprova.',
  ...
  'designFiles.usefulInfoTip7': 'Ti piace Composer Design? Lascia una stella su GitHub.',
  ...
  'assistant.shareToOpenDesign': 'Condividi su Composer Design',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Composer Design — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Composer Design — nessun download necessario.',
  ...
  'settings.projectLocationsDescription': 'Aggiungi basi di lavoro che possono contenere più cartelle di progetti Composer Design. I nuovi progetti vengono salvati come una cartella nella base selezionata.',
  ...
  'settings.memoryStarterProjectDesc': 'Composer Design v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'Composer Design {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. Composer Design si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.payloadReadyGeneric': 'A new Composer Design update is ready. Composer Design will close and restart automatically.',
  'updater.payloadReadyVersion': 'Composer Design {version} is ready. Composer Design will close and restart automatically.',
  'updater.quitButton': 'Esci da Composer Design',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma Composer Design non è riuscito a uscire. Esci da Composer Design prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. Composer Design si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'Composer Design {version} è pronto. Composer Design si chiuderà e aprirà il programma di installazione.',
  ...
  'dsManager.createBody': 'Insegna a Composer Design il tuo brand, prodotto, codice, asset e riferimenti di design.',
  ...
  'settings.customInstructionsDesc': 'Istruzioni fisse che Composer Design segue in ogni chat. Non sono memorie salvate; usa Memoria per fatti, preferenze e contesto del progetto.',
