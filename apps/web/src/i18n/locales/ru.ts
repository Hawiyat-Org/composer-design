...
export const ru: Dict = {
  ...
  'chat.amrCard.switchBody': 'Переключитесь на официальный сервис моделей AMR от Composer Design — без настройки API-ключа. После входа, авторизации и пополнения это выполнение будет автоматически повторено.',
  ...
  'chat.runError.signInMessage.amr': 'Агент Composer Design ещё не вошёл в систему — войдите, чтобы начать им пользоваться.',
  'chat.runError.signInMessage.other': '{agent} не выполнил вход. Проверьте статус входа локально. Рекомендуем агента Composer Design — стабильнее и выгоднее.',
  ...
  'settings.welcomeTitle': 'Добро пожаловать в Composer Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Начать с краткого описания',
  'settings.onboardingCreateBody': 'Опишите сайт, приложение, презентацию, изображение или видео, которое вам нужно. Composer Design создаст проект и сохранит возможность редактирования работы.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Эти ответы формируют основу вашего профиля Памяти. Composer Design использует его в каждой задаче и продолжает учиться, пока вы работаете.',
  ...
  'settings.onboardingCloudTitle': 'Войти в Composer Design',
  'settings.onboardingCloudBody': 'Войдите и сразу начните создавать с облачным ИИ — без сложных настроек.',
  'settings.onboardingCloudSignIn': 'Войти в Composer Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'Следующие шаги выполняются на ИИ — войдите в Composer Design AMR, чтобы продолжить.',
  ...
  'settings.agentInstall.pathHint': 'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Composer Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth': 'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Composer Design.',
  ...
  'settings.mcpServerHint': 'Откройте Composer Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'settings.privacyHint': 'Какие данные передаются команде Composer Design',
  'settings.privacyConsentKicker': 'Помогите нам улучшить Composer Design',
  'settings.privacyConsentLead': 'Composer Design может передавать данные об использовании нашей команде, чтобы помочь нам стать лучше. Сюда входят:',
  ...
  'settings.mcpHint': 'Позвольте агентам для кода (Cursor, Claude Code, VS Code…) напрямую читать ваши проекты Composer Design.',
  'settings.mcpDaemonError': 'Не удалось подключиться к локальному демону для определения путей установки ({error}). Убедитесь, что Composer Design запущен, затем снова откройте эту панель.',
  ...
  'settings.mcpCapabilityDefault': 'По умолчанию использовать проект и файл, открытые в Composer Design, чтобы можно было сказать «собери это в моём приложении», не уточняя, о каком дизайне идёт речь.',
  'settings.mcpRunningNote': 'Для успешного выполнения вызовов инструментов MCP необходимо, чтобы Composer Design был запущен. Если вы запустили своего агента для кодинга до открытия Composer Design, перезапустите агент, чтобы он мог подключиться к работающему демону.',
  ...
  'entry.discordAria': 'Присоединиться к Discord-сообществу Composer Design',
  'entry.discordAriaWithOnline': 'Присоединиться к Discord-сообществу Composer Design — {online}',
  ...
  'homeHero.chip.createPluginHint': 'Создайте многоразовый плагин Composer Design и добавьте его в раздел «Мои плагины».',
  ...
  'handoff.promptIntro': 'Продолжить из этой локальной папки проекта Composer Design:',
  ...
  'pluginsHome.subtitle': 'Готовые рабочие процессы Composer Design, входящие в состав этой среды выполнения. Выберите один, чтобы загрузить стартовый запрос, или просмотрите реестр для дополнительных вариантов.',
  ...
  'pluginsHome.emptyCatalog': 'Каталог пуст. Встроенные плагины поставляются вместе с Composer Design и должны появляться здесь автоматически — если проблема не исчезает, попробуйте перезапустить демон.',
  ...
  'pluginCard.contributeAria': 'Внести {title} в Composer Design',
  'pluginCard.contributeTitle': 'Внести плагин в Composer Design через pull request',
  ...
  'integrations.lede': 'Подключайте внешние системы, добавляйте инструменты MCP в цикл работы вашего агента и используйте Composer Design из других IDE, скриптов и средств автоматизации.',
  ...
  'mcpClient.daemonError': 'Не удалось подключиться к локальному демону. Убедитесь, что Composer Design запущен, затем снова откройте эту панель.',
  'mcpClient.saveFailed': 'Не удалось сохранить. Убедитесь, что демон запущен, и повторите попытку.',
  'useEverywhere.modalAria': 'Используйте Composer Design везде',
  'useEverywhere.modalTitle': 'Используйте Composer Design везде',
  'useEverywhere.modalSubtitle': 'Подключайте Composer Design к любой IDE, агенту или скрипту — CLI, HTTP, MCP и Skills. Используйте «Copy guide for an agent» и вставьте в Claude Code, Codex, Cursor, openclaw или hermes, чтобы настроить всё.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — готовые к использованию пакеты `SKILL.md` (совместимые с Claude), которые любой агент, уже находящийся в вашем PATH, может вызвать вообще без Composer Design.',
  ...
  'useEverywhere.section.cli.heading': 'Управляйте Composer Design из любой оболочки',
  ...
  'useEverywhere.section.mcp.heading': 'Предоставьте Composer Design как сервер MCP любому кодовому Agent',
  'useEverywhere.section.mcp.intro': 'Composer Design поставляется с сервером Model Context Protocol (`od mcp`), который позволяет любому клиенту с поддержкой MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — обнаруживать инструменты Composer Design (получать список навыков, отображать предпросмотры, генерировать медиа, запускать плагины) без ручного вызова через shell. Демон публикует готовый к вставке фрагмент установки через `GET /api/mcp/install-info` для каждого основного клиента.',
  ...
  'useEverywhere.section.mcp.footer': 'В приложении Composer Design откройте Settings → Integrations, чтобы скопировать команду установки для конкретного клиента (Cursor, Claude Code, Antigravity, VS Code) вместо ручного редактирования JSON.',
  ...
  'useEverywhere.section.skills.heading': 'Готовые к использованию Skills для любого агента — даже без запущенного Composer Design',
  'useEverywhere.section.skills.intro': 'Skill — это директория с совместимым с Claude файлом `SKILL.md` (YAML-фронтматтер + тело). Composer Design расширяет формат пространством имён `od:` (`mode`, `preview`, `design_system`, `inputs`, …), чтобы один и тот же артефакт можно было использовать как внутри Composer Design, так и обычным агентом, например Claude Code, Codex, openclaw или hermes. Обнаружение следует цепочке приоритетов, поэтому проекты могут переопределять свои собственные навыки.',
  ...
  'useEverywhere.section.skills.snippet1': 'Минимальный SKILL.md (совместимый с Claude front matter + дополнения Composer Design)',
  ...
  'entry.githubStarAria': 'Поставить Composer Design звезду на GitHub',
  ...
  'newproj.locationDefault': 'Проекты Composer Design',
  ...
  'socialShare.openDesignSection': 'Поделиться Composer Design',
  'socialShare.openDesignTitle': 'Composer Design на GitHub',
  'socialShare.openDesignText': 'Composer Design — это рабочее пространство с открытым исходным кодом для создания, редактирования, развёртывания и передачи дизайн-артефактов.',
  ...
  'socialShare.projectText': 'Создано с помощью Composer Design: {title}. Посмотрите развёрнутый артефакт и поставьте звезду репозиторию: {repo}',
  'socialShare.projectCopyText': 'Создано с помощью Composer Design: {title}\n{url}\nРепозиторий Composer Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Попросите Composer Design изменить {file}...',
  ...
  'chat.mode.design.solves': 'Используйте его, когда Composer Design должен сгенерировать файлы, обновить workspace или превратить бриф в мультимодальные deliverables.',
  ...
  'preview.shareTextDefault': 'Шаблон Composer Design: {title}',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Composer Design запущен, и повторите попытку.',
  ...
  'designFiles.usefulInfoTip7': 'Нравится Composer Design? Поставьте звезду на GitHub.',
  ...
  'assistant.shareToOpenDesign': 'Поделиться в Composer Design',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Composer Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Composer Design — загрузка не нужна.',
  ...
  'settings.projectLocationsDescription': 'Добавьте рабочие базы, которые могут содержать несколько папок проектов Composer Design. Новые проекты сохраняются как папка внутри выбранной базы.',
  ...
  'settings.customInstructionsHint': 'Постоянные инструкции, которым Composer Design должен следовать в каждом чате. Сохраняйте факты, предпочтения и контекст проекта в виде памяти.',
  ...
  'settings.memoryStarterProjectDesc': 'Composer Design v0.5 — редактор дизайна с управлением через чат',
  ...
  'updater.availableBody': 'Composer Design {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. Composer Design закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть Composer Design',
  'updater.quitFailedBody': 'Установщик открыт, но Composer Design не удалось закрыть. Закройте Composer Design перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. Composer Design закроется и откроет установщик.',
  'updater.readyVersion': 'Composer Design {version} готов. Composer Design закроется и откроет установщик.',
  ...
  'dsManager.createBody': 'Обучите Composer Design вашему бренду, продукту, коду, ресурсам и дизайн-референсам.',
  ...
  'settings.customInstructionsDesc': 'Фиксированные инструкции, которым Composer Design следует в каждом чате. Это не сохранённые воспоминания; используйте Память для фактов, предпочтений и контекста проекта.',
