...
import { getComposerDesignHost } from '@open-design/host';
...
// through `getComposerDesignHost` rather than reading the bridge global by
...
function readDesktopHostOsLocale(): string | undefined {
  ...
  const host = getComposerDesignHost();
