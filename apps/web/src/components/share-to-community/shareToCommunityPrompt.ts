// Trigger prompt for the post-completion "Share to Composer Design" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Composer Design plugin so I can install it into My plugins and open a PR to the Composer Design community catalog.',
  '',
  ...
  '- **Composer Design PR** — opens a draft PR against `hawiyat/composer-design` for the community catalog.',
  '',
