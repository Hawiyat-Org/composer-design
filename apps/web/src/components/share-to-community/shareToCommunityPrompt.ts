// Trigger prompt for the post-completion "Share to ComposerDesign" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an ComposerDesign plugin so I can install it into My plugins and open a PR to the ComposerDesign community catalog.',
  '',
  ...
  '- **ComposerDesign PR** — opens a draft PR against `nexu-io/open-design` for the community catalog.',
  '',
