...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  ...
  topic: 'packaging a reusable workflow as an Composer Design plugin',
};
...
export function HomeView({
  ...
  async function handlePickWorkingDir() {
    ...
    if (isOpenDesignHostAvailable()) {
      ...
      setError(
        `Couldn't open the folder picker (${'reason' in result ? result.reason : 'host unavailable'}). Please update Composer Design and try again.`,
      );
      return;
    }
