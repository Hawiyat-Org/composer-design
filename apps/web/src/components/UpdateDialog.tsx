...
function shouldRunManualCheck(status: ComposerDesignHostUpdaterStatusSnapshot): boolean {
...
export function UpdateDialog() {
  ...
  const statusRef = useRef<ComposerDesignHostUpdaterStatusSnapshot | null>(null);
  const statusRevisionRef = useRef(0);
  const laterRef = useRef<HTMLButtonElement | null>(null);
  const closeRef = useRef<HTMLButtonElement | null>(null);
  const primaryRef = useRef<HTMLButtonElement | null>(null);
  const [status, setStatus] = useState<ComposerDesignHostUpdaterStatusSnapshot | null>(null);
  ...
  const applyStatus = useCallback((next: ComposerDesignHostUpdaterStatusSnapshot) => {
