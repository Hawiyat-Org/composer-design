...
import type { ComposerDesignDiscordPresenceResponse } from '@open-design/contracts';
...
function cacheFromPayload(payload: Partial<ComposerDesignDiscordPresenceResponse>): CachedPresence | null {
  if (
