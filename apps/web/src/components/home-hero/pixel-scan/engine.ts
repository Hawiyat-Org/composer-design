...
// and assembles the ComposerDesign logo (mark + wordmark, sampled from an SVG)
...
// the component can lazy-import it, defaults carry the ComposerDesign wordmark and
