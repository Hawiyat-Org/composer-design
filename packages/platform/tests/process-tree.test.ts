...
describe("processCommandExactlyRunsExecutable", () => {
  it("accepts exact POSIX and quoted Windows executable commands", () => {
    expect(processCommandExactlyRunsExecutable(
      "/Applications/Composer Design.app/Contents/MacOS/Composer Design",
      "/Applications/Composer Design.app/Contents/MacOS/Composer Design",
      "darwin",
    )).toBe(true);
    expect(processCommandExactlyRunsExecutable(
      '"C:\\Program Files\\Composer Design\\Composer Design.exe"',
      "C:\\Program Files\\Composer Design\\Composer Design.exe",
      "win32",
    )).toBe(true);
  });
  ...
  it("rejects arguments and lookalike executable prefixes", () => {
    const executable = "/Applications/Composer Design.app/Contents/MacOS/Composer Design";
    ...
    const windowsExecutable = "C:\\Program Files\\Composer Design\\Composer Design.exe";
    expect(processCommandExactlyRunsExecutable(
