 ...
 * ownership sentinel that marks a base directory as ComposerDesign-owned, refuses to
...
/**
 * Ensure `basePath` is an ComposerDesign-owned managed base: create it if missing,
